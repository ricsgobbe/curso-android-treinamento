...
public class ServiceModule {
    ...
    GitHubService providesGitHub(
            @Named(NetworkModule.RETROFIT_GITHUB) Retrofit retrofit) {
    ...
    GitHubStatusService providesGitHubStatus(
            @Named(NetworkModule.RETROFIT_GITHUB_STATUS) Retrofit retrofit) {
    ...
    GitHubOAuthService providesGitHubOAuth(
            @Named(NetworkModule.RETROFIT_GITHUB_OAUTH) Retrofit retrofit) {
